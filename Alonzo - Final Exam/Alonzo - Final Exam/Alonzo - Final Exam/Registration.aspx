              ...
              <div class="detail-box">
                ...
                <p>
                    ...
                    <table class="auto-style9">
                        <tr>
                            <td class="auto-style10" style="height: 74px"><strong>Email:
                                <br />
                  ...
                  <span class="auto-style2">
                        ...
                        <tr>
                            <td class="auto-style10" style="height: 26px"><strong>First Name:<br />
                        ...
                        <tr>
                            <td class="auto-style10" style="height: 25px"><strong>Basic Monthly Salary:<br />
                        ...
                        <tr>
                            <td class="auto-style2"><strong>Password:<br />
                  ...
                  <span class="auto-style2">
                      <br />
                      <asp:Button ID="btnRegister" runat="server" BackColor="#3A4468" BorderStyle="None" ForeColor="White" Height="40px" OnClick="Button2_Click" Text="Register" Width="115px" />
                                <br />
                  <strong>
