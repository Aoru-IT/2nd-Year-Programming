        ...
        <div class="container-fluid">
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ">
                <li class="nav-item">
                  <a class="nav-link" href="HomePage.aspx">Loan Calculator</a>
                </li>
                                           ...
                                           <asp:Panel ID="Panel1" runat="server" Visible="False">
                                               ...
                                               <p>
                                                   <table class="auto-style3">
                                                       <tr>
                                                           <td class="auto-style7" style="width: 214px; height: 26px;"><strong>Number of months:</strong></td>
                                                       ...
                                                       <tr>
                                                           <td class="auto-style7" style="width: 214px"><strong>Take Home Loan:</strong></td>
                                                           <td class="auto-style5" style="width: 225px">
                                                   ...
                                                   <p>
                                                       <asp:Button ID="btnApply" runat="server" BackColor="#3A4468" BorderStyle="None" ForeColor="White" Height="40px" OnClick="btnConfirm_Click" Text="Apply" Width="115px" />
                                           </asp:Panel>
                                       </div>
                                   </div>
                                   <div class="col-md-6">
