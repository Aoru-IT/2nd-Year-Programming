<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ViewPending.aspx.cs" Inherits="Alonzo___Final_Exam.WebForm4" %>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav">
                <li class="nav-item active">
                  <a class="nav-link active" href="ViewPending.aspx">View Pending / Approved Loans<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="GrantLoans.aspx">Grant Loans
                    </a>
                </li>
                ...
                <div class="col-md-6">
                  <div class="detail-box">
                    <h1>
                        Pending Loans</h1>
                    <p>
                        Pending Loans will be displayed here.</p>
                    ...
                    <h1>
                        Approved Loans</h1>
                      <p>
                          Approved Loans will be displayed here.</p>
                                               <asp:GridView ID="GridView2" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" CssClass="centered padded center-padded" Height="156px" Width="279px" AutoGenerateColumns="False">
                                                   <Columns>
                                                       <asp:BoundField DataField="Email" HeaderText="Email" />
                                                       <asp:BoundField DataField="FirstName" HeaderText="First Name" />
                                                       <asp:BoundField DataField="LastName" HeaderText="Last Name" />
